...
import { DetailShop } from '@/src/components/common/ui-detail-shop/DetailShop';
import { ShopLayout } from '@/src/layouts/shop-layout/ShopLayout';
import { getShops } from '@/src/apis/shops';
...
export default function Shop() {
  ...
  return (
    <Layout>
      <ShopLayout
        detail={<DetailShop shop={shop} />}
        list={<ListNotice title={shop.name} location={shop.address1} shopId={shopId} />}
      />
    </Layout>
  );
}
